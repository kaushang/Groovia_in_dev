      ...
      <div className="max-w-md w-full ">
        <GlassPanel className="p-8">
          <div className="text-center mb-6 -mt-4">
            ...
            <p className="text-gray-100 mt-1">Join the collaborative music experience</p>
          </div>

          {/* Auth Toggle */}
          <div className="flex mb-6 glass-panel rounded-lg space-x-1 p-1">
            <Button
              variant={authMode === 'login' ? 'default' : 'ghost'}
              onClick={() => setAuthMode('login')}
              className="flex-1 py-2 rounded-md hover:bg-white/10 hover:text-white transition-all"
          ...
          {authMode === 'login' && (
            <form onSubmit={handleLogin} className="space-y-5">
              <div>
                <Label htmlFor="emailOrUsername" className="text-gray-100">Email or Username</Label>
                <Input
                  id="emailOrUsername"
                  type="text"
                  required
              ...
              <div>
                ...
                <Input
                  ...
                  className="bg-white/10 border-white/20 text-white placeholder:text-gray-400 focus:ring-2 focus:ring-purple-400 mb-2"
              ...
              <div className="flex items-center justify-end">
                {/* <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="rememberMe" className="text-sm text-gray-100">Remember me</Label>
                </div> */}
                <Button variant="link" className="text-sm text-purple-300 hover:text-purple-200 p-0 -mt-4 -mb-6" data-testid="link-forgot-password">
                  Forgot password?
                </Button>
              </div>
            </form>
          ...
          {authMode === 'signup' && (
            <form onSubmit={handleSignup} className="space-y-5">
              ...
              <div>
                <Label htmlFor="signupPassword" className="text-gray-100">Password</Label>
                <Input
                  id="signupPassword"
                  type="password"
                  required
